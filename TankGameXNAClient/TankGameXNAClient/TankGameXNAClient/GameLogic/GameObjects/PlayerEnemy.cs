    ...
    class PlayerEnemy:Player
    {
        ...
        public override void Draw()
        {
            ...
            if (OldX == X && OldY == Y)
            {
                SmoothX = 0;
                SmoothY = 0;
                Global.SpriteBatch.Draw(playerTexture, new Vector2(10 + (32 * Global.ScaleFactor) + (X * Global.ScaleFactor * 64), 10 + (32 * Global.ScaleFactor) + (Y * Global.ScaleFactor * 64)), null, Color.Red, RotationAngle, new Vector2(32, 32), Global.ScaleFactor, SpriteEffects.None, 0);
            ...
            else
            {
                ...
                Global.SpriteBatch.Draw(playerTexture, new Vector2(10 + (32 * Global.ScaleFactor) + ((OldX + SmoothX) * Global.ScaleFactor * 64), 10 + (32 * Global.ScaleFactor) + ((OldY + SmoothY) * Global.ScaleFactor * 64)), null, Color.Red, RotationAngle, new Vector2(32, 32), Global.ScaleFactor, SpriteEffects.None, 0);
